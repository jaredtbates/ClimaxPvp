...
public enum ParticleEffect2 {
     ...
     */
    private ParticleEffect2(String name, int id, int requiredVersion, ParticleProperty... properties) {
        this.name = name;
        this.id = id;
     ...
     */
    public static ParticleEffect2 fromName(String name) {
     ...
     * @return The particle effect
     */
    public static ParticleEffect2 fromId(int id) {
     ...
     */
    private static boolean isDataCorrect(ParticleEffect2 effect, ParticleData data) {
     ...
     */
    private static boolean isColorCorrect(ParticleEffect2 effect, ParticleColor color) {
     ...
     * @see ParticlePacket#ParticlePacket(ParticleEffect2, Vector, float, boolean, ParticleData)
     * @see ParticlePacket#sendTo(Location, double)
     */
     ...
     * @see ParticlePacket#ParticlePacket(ParticleEffect2, ParticleColor, boolean)
     * @see ParticlePacket#sendTo(Location, double)
     */
     ...
     * <p>
     * This class is part of the <b>ParticleEffect2 Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
     * @since 1.7
     */
    ...
    /**
     * Represents the particle data for effects like {@link ParticleEffect2#ITEM_CRACK}, {@link ParticleEffect2#BLOCK_CRACK} and {@link ParticleEffect2#BLOCK_DUST}
     * <p>
     * This class is part of the <b>ParticleEffect2 Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the block data for the {@link ParticleEffect2#BLOCK_CRACK} and {@link ParticleEffect2#BLOCK_DUST} effects
     * <p>
     * This class is part of the <b>ParticleEffect2 Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the color for effects like {@link ParticleEffect2#SPELL_MOB}, {@link ParticleEffect2#SPELL_MOB_AMBIENT}, {@link ParticleEffect2#REDSTONE} and {@link ParticleEffect2#NOTE}
     * <p>
     * This class is part of the <b>ParticleEffect2 Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the color for effects like {@link ParticleEffect2#SPELL_MOB}, {@link ParticleEffect2#SPELL_MOB_AMBIENT} and {@link ParticleEffect2#NOTE}
     * <p>
     * This class is part of the <b>ParticleEffect2 Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    /**
     * Represents the color for the {@link ParticleEffect2#NOTE} effect
     * <p>
     * This class is part of the <b>ParticleEffect2 Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public static final class ParticlePacket {
         ...
         * @see #initialize()
         */
        public ParticlePacket(ParticleEffect2 effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleData data) throws IllegalArgumentException {
            initialize();
            if (speed < 0) {
         ...
         * @see #ParticleEffect(ParticleEffect2, float, float, float, float, int, boolean, ParticleData)
         */
        public ParticlePacket(ParticleEffect2 effect, Vector direction, float speed, boolean longDistance, ParticleData data) throws IllegalArgumentException {
         ...
         * @see #ParticleEffect(ParticleEffect2, float, float, float, float, int, boolean, ParticleData)
         */
        public ParticlePacket(ParticleEffect2 effect, ParticleColor color, boolean longDistance) {
            this(effect, color.getValueX(), color.getValueY(), color.getValueZ(), 1, 0, longDistance, null);
            if (effect == ParticleEffect2.REDSTONE && color instanceof OrdinaryColor && ((OrdinaryColor) color).getRed() == 0) {
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    if (data != null) {
                        ...
                        ReflectionUtils.setValue(packet, true, "k", effect == ParticleEffect2.ITEM_CRACK ? packetData : new int[]{packetData[0] | (packetData[1] << 12)});
                    }
                }
